<?php
    ...
    $total_price = $price * $quantity; // totale prijs berekenen (Zonder BTW en Servicekosten)
    $btw = $price * $quantity  / 121 * 21; // BTW berekenen "21%"
    $total = $price * $quantity + $btw + 1.25; // Totale prijs berekenen (Met BTW en Servicekosten)
?>
